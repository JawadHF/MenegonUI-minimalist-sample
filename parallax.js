...
class Item {
    constructor(el) {
        ...
        this.DOM = { el: el };
        // the inner image
        this.DOM.image = this.DOM.el.querySelector('.product-section-picture img');
        console.log('image element: '+ this.DOM.image.src);

        console.log('Max value: '+ getComputedStyle(this.DOM.image).getPropertyValue('--overflow'), 10);
        ...
        this.renderedStyles = {
            ...
            innerTranslationY: {
                ...
                setValue: () => {
                    console.log('1: '+ this.renderedStyles.innerTranslationY.maxValue);
                    const maxValue = this.renderedStyles.innerTranslationY.maxValue;
                    console.log('2: '+maxValue);

                    const minValue = -1 * maxValue;
                    console.log('2: '+minValue);
                    return Math.max(
                        Math.min(
                            MathUtils.map(
        ...
        console.log('Rendered element previous style: '+ this.renderedStyles.innerTranslationY.previous);
        console.log('Rendered element current style: '+ this.renderedStyles.innerTranslationY.current);
        console.log('Rendered element maxValue of style: '+ this.renderedStyles.innerTranslationY.maxValue);
    ...
    layout() {
        //console.log(this.renderedStyles.innerTranslationY);
        // console.log('Translating '+ this.DOM.image +'image style from: '+this.DOM.image.style.transform+' to '+this.renderedStyles.innerTranslationY.previous);
        // translates the image
        this.DOM.image.style.transform = `translate3d(0,${this.renderedStyles.innerTranslationY.previous}px,0)`;
        
        // console.log('Translated image to: '+this.DOM.image.style.transform)
    }
}
...
class SmoothScroll {
    ...
    constructor() {
        ...
        this.items = [];
        [...this.DOM.main.querySelectorAll('.product-section-background > .product-section-scaling-container')].forEach(item => this.items.push(new Item(item)));
